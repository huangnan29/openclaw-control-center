...
export const OPENCLAW_CONFIG_PATH = readOptionalStringEnv(process.env.OPENCLAW_CONFIG_PATH);
...
export const MANAGED_ACTIONS_LIVE_EXECUTOR_ENABLED = process.env.MANAGED_ACTIONS_LIVE_EXECUTOR_ENABLED === "true";
export const MANAGED_ACTIONS_LIVE_SKILL_RUN_ALLOWED_SKILLS = readCsvEnv(
  process.env.MANAGED_ACTIONS_LIVE_SKILL_RUN_ALLOWED_SKILLS,
);
export const MANAGED_ACTIONS_LIVE_SKILL_RUN_ALLOWED_INSTANCES = readCsvEnv(
  process.env.MANAGED_ACTIONS_LIVE_SKILL_RUN_ALLOWED_INSTANCES,
);
export const MANAGED_ACTIONS_LIVE_SKILL_RUN_MAX_TIMEOUT_SECONDS = parsePositiveInt(
  process.env.MANAGED_ACTIONS_LIVE_SKILL_RUN_MAX_TIMEOUT_SECONDS,
  600,
);
export const MANAGED_ACTIONS_LIVE_SKILL_RUN_DELIVER_ENABLED =
  process.env.MANAGED_ACTIONS_LIVE_SKILL_RUN_DELIVER_ENABLED === "true";
